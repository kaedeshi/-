...
$from = "nanikoresolutions@gmail.com";
...
$require = array('お名前','メールアドレス','電話番号','お問い合わせ種別','お問い合わせ内容');
...
お問い合わせありがとうございました。
内容を確認次第ご連絡させていただきますので、今しばらくお待ちください。
お問い合わせ状況や、お問い合わせ内容によってはお時間をいただく場合もございますので、あらかじめご了承ください。
...
──────────────────────
ナニコレソリューションズ株式会社　代表取締役　中川祐也
〒556-0006 大阪府大阪市浪速区日本橋東1-8-5-903
TEL：06-7777-1304
──────────────────────
